...
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_LpspecdataImpl:
        ...
        if uuid in Context._serviceEndPoint:
            if connectionEndPoint_uuid in Context._serviceEndPoint[uuid]._connectionEndPoint:
                if localId in Context._serviceEndPoint[uuid]._connectionEndPoint[connectionEndPoint_uuid]._layerProtocol:
                    return Context._serviceEndPoint[uuid]._connectionEndPoint[connectionEndPoint_uuid]._layerProtocol[localId]._lpSpecData
                else:
