...
class Context_ConnectivityserviceUuid_ConnectionConnection_Uuid_ConnectionportImpl:
    ...
    def get(cls, uuid, connection_uuid):
        ...
        if uuid in Context._connectivityService:
            if connection_uuid in Context._connectivityService[uuid]._connection:
                return Context._connectivityService[uuid]._connection[connection_uuid]._connectionPort
            else:
