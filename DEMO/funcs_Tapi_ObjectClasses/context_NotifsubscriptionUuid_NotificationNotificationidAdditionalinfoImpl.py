...
class Context_NotifsubscriptionUuid_NotificationNotificationidAdditionalinfoImpl:
    ...
    def get(cls, uuid, notificationId):
        ...
        if uuid in Context._notifSubscription:
            if notificationId in Context._notifSubscription[uuid]._notification:
                return Context._notifSubscription[uuid]._notification[notificationId].additionalInfo
            else:
