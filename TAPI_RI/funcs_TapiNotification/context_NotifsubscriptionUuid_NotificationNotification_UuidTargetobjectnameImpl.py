...
class Context_NotifsubscriptionUuid_NotificationNotification_UuidTargetobjectnameImpl:
    ...
    def get(cls, uuid, notification_uuid):
        ...
        if uuid in be.Context._notifSubscription:
            if notification_uuid in be.Context._notifSubscription[uuid]._notification:
                return be.Context._notifSubscription[uuid]._notification[notification_uuid].targetObjectName
            else:
