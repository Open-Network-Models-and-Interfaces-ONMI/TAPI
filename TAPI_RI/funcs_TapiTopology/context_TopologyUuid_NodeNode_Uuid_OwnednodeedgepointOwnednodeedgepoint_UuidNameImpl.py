...
class Context_TopologyUuid_NodeNode_Uuid_OwnednodeedgepointOwnednodeedgepoint_UuidNameImpl:
        ...
        if uuid in be.Context._topology:
            if node_uuid in be.Context._topology[uuid]._node:
                if ownedNodeEdgePoint_uuid in be.Context._topology[uuid]._node[node_uuid]._ownedNodeEdgePoint:
                    return be.Context._topology[uuid]._node[node_uuid]._ownedNodeEdgePoint[ownedNodeEdgePoint_uuid].name
                else:
