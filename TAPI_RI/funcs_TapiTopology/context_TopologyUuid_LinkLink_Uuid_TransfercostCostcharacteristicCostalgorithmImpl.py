    ...
    def get(cls, uuid, link_uuid, costAlgorithm):
        ...
        if uuid in be.Context._topology:
            if link_uuid in be.Context._topology[uuid]._link:
                if costAlgorithm in be.Context._topology[uuid]._link[link_uuid]._transferCost.costCharacteristic:
                    return be.Context._topology[uuid]._link[link_uuid]._transferCost.costCharacteristic[costAlgorithm]
                else:
