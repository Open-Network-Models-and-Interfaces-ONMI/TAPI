    ...
    def get(cls, uuid, node_uuid, latencyValue):
        ...
        if uuid in be.Context._topology:
            if node_uuid in be.Context._topology[uuid]._node:
                if latencyValue in be.Context._topology[uuid]._node[node_uuid]._transferTiming.queuingLatency:
                    return be.Context._topology[uuid]._node[node_uuid]._transferTiming.queuingLatency[latencyValue]
                else:
