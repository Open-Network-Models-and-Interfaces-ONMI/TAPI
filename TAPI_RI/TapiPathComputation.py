...
from funcs_TapiPathComputation.context_PathcompserviceUuid_RoutingconstraintCostcharacteristicCostalgorithmImpl import Context_PathcompserviceUuid_RoutingconstraintCostcharacteristicCostalgorithmImpl
...
from funcs_TapiPathComputation.context_PathUuid_RoutingconstraintRiskcharacteristicImpl import Context_PathUuid_RoutingconstraintRiskcharacteristicImpl
...
from funcs_TapiPathComputation.context_PathcompserviceUuid_RoutingconstraintRiskcharacteristicRiskcharacteristicnameImpl import Context_PathcompserviceUuid_RoutingconstraintRiskcharacteristicRiskcharacteristicnameImpl
...
from funcs_TapiPathComputation.context_PathcompserviceUuid_RoutingconstraintRiskcharacteristicImpl import Context_PathcompserviceUuid_RoutingconstraintRiskcharacteristicImpl
...
from funcs_TapiPathComputation.context_PathUuid_RoutingconstraintLatencycharacteristicLatencyvalueImpl import Context_PathUuid_RoutingconstraintLatencycharacteristicLatencyvalueImpl
...
from funcs_TapiPathComputation.context_PathcompserviceUuid_RoutingconstraintLatencycharacteristicLatencyvalueImpl import Context_PathcompserviceUuid_RoutingconstraintLatencycharacteristicLatencyvalueImpl
...
from funcs_TapiPathComputation.context_PathUuid_RoutingconstraintRiskcharacteristicRiskcharacteristicnameImpl import Context_PathUuid_RoutingconstraintRiskcharacteristicRiskcharacteristicnameImpl
from funcs_TapiPathComputation.context_PathcompserviceUuidLabelImpl import Context_PathcompserviceUuidLabelImpl
from funcs_TapiPathComputation.context_PathUuid_RoutingconstraintCostcharacteristicCostalgorithmImpl import Context_PathUuid_RoutingconstraintCostcharacteristicCostalgorithmImpl
...
from objects_TapiPathComputation.service import Service
...
from objects_TapiPathComputation.queuingLatency import QueuingLatency
...
from objects_TapiPathComputation.resource import Resource
...
class Context_PathcompserviceUuid_RoutingconstraintCostcharacteristicCostalgorithmMethodView(MethodView):
...
#/restconf/config/Context/_path/(\w+)/_routingConstraint/riskCharacteristic/
class Context_PathUuid_RoutingconstraintRiskcharacteristicMethodView(MethodView):

    def get(self, uuid):
        print "Retrieve operation of resource: riskCharacteristic"
        try:
            response = Context_PathUuid_RoutingconstraintRiskcharacteristicImpl.get(uuid)
        except KeyError as inst:
            return NotFoundError(inst.args[0] + " not found")
        else:
            js = response.json_serializer()
...
class Context_PathcompserviceUuid_RoutingconstraintRiskcharacteristicRiskcharacteristicnameMethodView(MethodView):
...
class Context_PathcompserviceUuid_RoutingconstraintRiskcharacteristicMethodView(MethodView):
...
class Context_PathUuid_RoutingconstraintLatencycharacteristicLatencyvalueMethodView(MethodView):
...
class Context_PathcompserviceUuid_RoutingconstraintLatencycharacteristicLatencyvalueMethodView(MethodView):
...
class Context_PathUuid_RoutingconstraintRiskcharacteristicRiskcharacteristicnameMethodView(MethodView):
...
class Context_PathUuid_RoutingconstraintCostcharacteristicCostalgorithmMethodView(MethodView):
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_pathCompService/<uuid>/_routingConstraint/costCharacteristic/<costAlgorithm>/", view_func = globals()["Context_PathcompserviceUuid_RoutingconstraintCostcharacteristicCostalgorithmMethodView"].as_view('"Context_PathcompserviceUuid_RoutingconstraintCostcharacteristicCostalgorithm"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_path/<uuid>/_routingConstraint/riskCharacteristic/", view_func = globals()["Context_PathUuid_RoutingconstraintRiskcharacteristicMethodView"].as_view('"Context_PathUuid_RoutingconstraintRiskcharacteristic"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_pathCompService/<uuid>/_routingConstraint/riskCharacteristic/<riskCharacteristicName>/", view_func = globals()["Context_PathcompserviceUuid_RoutingconstraintRiskcharacteristicRiskcharacteristicnameMethodView"].as_view('"Context_PathcompserviceUuid_RoutingconstraintRiskcharacteristicRiskcharacteristicname"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_pathCompService/<uuid>/_routingConstraint/riskCharacteristic/", view_func = globals()["Context_PathcompserviceUuid_RoutingconstraintRiskcharacteristicMethodView"].as_view('"Context_PathcompserviceUuid_RoutingconstraintRiskcharacteristic"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_path/<uuid>/_routingConstraint/latencyCharacteristic/<latencyValue>/", view_func = globals()["Context_PathUuid_RoutingconstraintLatencycharacteristicLatencyvalueMethodView"].as_view('"Context_PathUuid_RoutingconstraintLatencycharacteristicLatencyvalue"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_pathCompService/<uuid>/_routingConstraint/latencyCharacteristic/<latencyValue>/", view_func = globals()["Context_PathcompserviceUuid_RoutingconstraintLatencycharacteristicLatencyvalueMethodView"].as_view('"Context_PathcompserviceUuid_RoutingconstraintLatencycharacteristicLatencyvalue"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_path/<uuid>/_routingConstraint/riskCharacteristic/<riskCharacteristicName>/", view_func = globals()["Context_PathUuid_RoutingconstraintRiskcharacteristicRiskcharacteristicnameMethodView"].as_view('"Context_PathUuid_RoutingconstraintRiskcharacteristicRiskcharacteristicname"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_path/<uuid>/_routingConstraint/costCharacteristic/<costAlgorithm>/", view_func = globals()["Context_PathUuid_RoutingconstraintCostcharacteristicCostalgorithmMethodView"].as_view('"Context_PathUuid_RoutingconstraintCostcharacteristicCostalgorithm"'+'"_api"'), methods=['GET'])
