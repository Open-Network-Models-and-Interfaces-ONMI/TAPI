...
from funcs_TapiConnectivity.context_ServiceendpointUuidNameImpl import Context_ServiceendpointUuidNameImpl
from funcs_TapiConnectivity.getconnectivityservicedetailsImpl import GetconnectivityservicedetailsImpl
from funcs_TapiConnectivity.context_ConnectivityserviceUuid_ConnconstraintLatencycharacteristicLatencyvalueImpl import Context_ConnectivityserviceUuid_ConnconstraintLatencycharacteristicLatencyvalueImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_LayerprotocolImpl import Context_ServiceendpointUuid_LayerprotocolImpl
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsExtensionsspecificationImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsExtensionsspecificationImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuidNameValuenameImpl import Context_ServiceendpointUuidNameValuenameImpl
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsExtensionsspecificationImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsExtensionsspecificationImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_LayerprotocolLocalid_ExtensionsImpl import Context_ServiceendpointUuid_LayerprotocolLocalid_ExtensionsImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidLabelImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidLabelImpl
from funcs_TapiConnectivity.context_ServiceendpointUuidImpl import Context_ServiceendpointUuidImpl
...
from funcs_TapiConnectivity.context_ConnectivityserviceUuid_ConnconstraintCostcharacteristicCostalgorithmImpl import Context_ConnectivityserviceUuid_ConnconstraintCostcharacteristicCostalgorithmImpl
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalidImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalidImpl
...
from funcs_TapiConnectivity.context_ServiceendpointImpl import Context_ServiceendpointImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidLabelValuenameImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidLabelValuenameImpl
from funcs_TapiConnectivity.context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristicImpl import Context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristicImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuidLabelValuenameImpl import Context_ServiceendpointUuidLabelValuenameImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuidLabelImpl import Context_ServiceendpointUuidLabelImpl
...
from funcs_TapiConnectivity.context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristicRiskcharacteristicnameImpl import Context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristicRiskcharacteristicnameImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_ExtensionsExtensionsspecificationImpl import Context_ServiceendpointUuid_ExtensionsExtensionsspecificationImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsImpl
from funcs_TapiConnectivity.context_ConnectionUuidImpl import Context_ConnectionUuidImpl
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointImpl import Context_ServiceendpointUuid_ConnectionendpointImpl
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidNameValuenameImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidNameValuenameImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidNameImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidNameImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_LayerprotocolLocalidImpl import Context_ServiceendpointUuid_LayerprotocolLocalidImpl
...
from funcs_TapiConnectivity.context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_StateImpl import Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_StateImpl
from funcs_TapiConnectivity.context_ConnectionUuid_ExtensionsImpl import Context_ConnectionUuid_ExtensionsImpl
from funcs_TapiConnectivity.context_ServiceendpointUuid_StateImpl import Context_ServiceendpointUuid_StateImpl
from funcs_TapiConnectivity.context_ServiceendpointUuid_ExtensionsImpl import Context_ServiceendpointUuid_ExtensionsImpl
from funcs_TapiConnectivity.context_ConnectionUuid_StateImpl import Context_ConnectionUuid_StateImpl
from funcs_TapiConnectivity.context_ServiceendpointUuid_LayerprotocolLocalid_ExtensionsExtensionsspecificationImpl import Context_ServiceendpointUuid_LayerprotocolLocalid_ExtensionsExtensionsspecificationImpl
...
from objects_TapiConnectivity.service import Service
...
from objects_TapiConnectivity.queuingLatency import QueuingLatency
...
from objects_TapiConnectivity.resource import Resource
...
class Context_ConnectivityserviceUuid_ConnconstraintLatencycharacteristicLatencyvalueMethodView(MethodView):

    def get(self, uuid, latencyValue):
        print "Retrieve operation of resource: latencyCharacteristic"
        try:
            response = Context_ConnectivityserviceUuid_ConnconstraintLatencycharacteristicLatencyvalueImpl.get(uuid, latencyValue)
        except KeyError as inst:
            return NotFoundError(inst.args[0] + " not found")
        else:
            js = response.json_serializer()
...
#/restconf/config/Context/_serviceEndPoint/(\w+)/_connectionEndPoint/(\w+)/_extensions/
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsMethodView(MethodView):

    def get(self, uuid, connectionEndPoint_uuid):
        print "Retrieve operation of resource: _extensions"
        try:
            response = Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsImpl.get(uuid, connectionEndPoint_uuid)
        except KeyError as inst:
            return NotFoundError(inst.args[0] + " not found")
        else:
            js = response.json_serializer()
...
#/restconf/config/Context/_serviceEndPoint/(\w+)/_connectionEndPoint/(\w+)/_extensions/(\w+)/
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsExtensionsspecificationMethodView(MethodView):

    def get(self, uuid, connectionEndPoint_uuid, extensionsSpecification):
        print "Retrieve operation of resource: _extensions"
        try:
            response = Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsExtensionsspecificationImpl.get(uuid, connectionEndPoint_uuid, extensionsSpecification)
        except KeyError as inst:
            return NotFoundError(inst.args[0] + " not found")
        else:
            js = response.json_serializer()
...
#/restconf/config/Context/_serviceEndPoint/(\w+)/_connectionEndPoint/(\w+)/_layerProtocol/(\w+)/_extensions/(\w+)/
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsExtensionsspecificationMethodView(MethodView):

    def get(self, uuid, connectionEndPoint_uuid, localId, extensionsSpecification):
        print "Retrieve operation of resource: _extensions"
        try:
            response = Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsExtensionsspecificationImpl.get(uuid, connectionEndPoint_uuid, localId, extensionsSpecification)
        except KeyError as inst:
            return NotFoundError(inst.args[0] + " not found")
        else:
            js = response.json_serializer()
...
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidLabelMethodView(MethodView):
...
class Context_ConnectivityserviceUuid_ConnconstraintCostcharacteristicCostalgorithmMethodView(MethodView):

    def get(self, uuid, costAlgorithm):
        print "Retrieve operation of resource: costCharacteristic"
        try:
            response = Context_ConnectivityserviceUuid_ConnconstraintCostcharacteristicCostalgorithmImpl.get(uuid, costAlgorithm)
        except KeyError as inst:
            return NotFoundError(inst.args[0] + " not found")
        else:
            js = response.json_serializer()
...
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalidMethodView(MethodView):
...
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidLabelValuenameMethodView(MethodView):
...
#/restconf/config/Context/_connectivityService/(\w+)/_connConstraint/riskCharacteristic/
class Context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristicMethodView(MethodView):

    def get(self, uuid):
        print "Retrieve operation of resource: riskCharacteristic"
        try:
            response = Context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristicImpl.get(uuid)
        except KeyError as inst:
            return NotFoundError(inst.args[0] + " not found")
        else:
            js = response.json_serializer()
...
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolMethodView(MethodView):
...
#/restconf/config/Context/_connectivityService/(\w+)/_connConstraint/riskCharacteristic/(\w+)/
class Context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristicRiskcharacteristicnameMethodView(MethodView):

    def get(self, uuid, riskCharacteristicName):
        print "Retrieve operation of resource: riskCharacteristic"
        try:
            response = Context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristicRiskcharacteristicnameImpl.get(uuid, riskCharacteristicName)
        except KeyError as inst:
            return NotFoundError(inst.args[0] + " not found")
        else:
            js = response.json_serializer()
...
#/restconf/config/Context/_serviceEndPoint/(\w+)/_connectionEndPoint/(\w+)/_layerProtocol/(\w+)/_extensions/
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsMethodView(MethodView):

    def get(self, uuid, connectionEndPoint_uuid, localId):
        print "Retrieve operation of resource: _extensions"
        try:
            response = Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsImpl.get(uuid, connectionEndPoint_uuid, localId)
        except KeyError as inst:
            return NotFoundError(inst.args[0] + " not found")
        else:
            js = response.json_serializer()
...
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidMethodView(MethodView):
...
class Context_ServiceendpointUuid_ConnectionendpointMethodView(MethodView):
...
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidNameValuenameMethodView(MethodView):
...
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidNameMethodView(MethodView):
...
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_StateMethodView(MethodView):
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_connectivityService/<uuid>/_connConstraint/latencyCharacteristic/<latencyValue>/", view_func = globals()["Context_ConnectivityserviceUuid_ConnconstraintLatencycharacteristicLatencyvalueMethodView"].as_view('"Context_ConnectivityserviceUuid_ConnconstraintLatencycharacteristicLatencyvalue"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/_extensions/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_Extensions"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/_extensions/<extensionsSpecification>/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsExtensionsspecificationMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsExtensionsspecification"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/_layerProtocol/<localId>/_extensions/<extensionsSpecification>/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsExtensionsspecificationMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsExtensionsspecification"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/label/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidLabelMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidLabel"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_connectivityService/<uuid>/_connConstraint/costCharacteristic/<costAlgorithm>/", view_func = globals()["Context_ConnectivityserviceUuid_ConnconstraintCostcharacteristicCostalgorithmMethodView"].as_view('"Context_ConnectivityserviceUuid_ConnconstraintCostcharacteristicCostalgorithm"'+'"_api"'), methods=['GET'])
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/_layerProtocol/<localId>/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalidMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/label/<valueName>/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidLabelValuenameMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidLabelValuename"'+'"_api"'), methods=['GET'])
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_connectivityService/<uuid>/_connConstraint/riskCharacteristic/", view_func = globals()["Context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristicMethodView"].as_view('"Context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristic"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/_layerProtocol/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_Layerprotocol"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_connectivityService/<uuid>/_connConstraint/riskCharacteristic/<riskCharacteristicName>/", view_func = globals()["Context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristicRiskcharacteristicnameMethodView"].as_view('"Context_ConnectivityserviceUuid_ConnconstraintRiskcharacteristicRiskcharacteristicname"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/_layerProtocol/<localId>/_extensions/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_Extensions"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointMethodView"].as_view('"Context_ServiceendpointUuid_Connectionendpoint"'+'"_api"'), methods=['GET'])
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/name/<valueName>/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidNameValuenameMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidNameValuename"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/name/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidNameMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_UuidName"'+'"_api"'), methods=['GET'])
...
getattr(sys.modules[__name__], __name__).add_url_rule("/restconf/config/Context/_serviceEndPoint/<uuid>/_connectionEndPoint/<connectionEndPoint_uuid>/_state/", view_func = globals()["Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_StateMethodView"].as_view('"Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_State"'+'"_api"'), methods=['GET'])
