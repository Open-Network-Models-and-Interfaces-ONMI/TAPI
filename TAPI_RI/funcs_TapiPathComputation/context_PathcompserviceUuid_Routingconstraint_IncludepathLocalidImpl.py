...
class Context_PathcompserviceUuid_Routingconstraint_IncludepathLocalidImpl:
    ...
    def get(cls, uuid, localId):
        ...
        if uuid in be.Context._pathCompService:
            if localId in be.Context._pathCompService[uuid]._routingConstraint._includePath:
                return be.Context._pathCompService[uuid]._routingConstraint._includePath[localId]
            else:
