...
from objects_Tapi.resource import Resource
from objects_Tapi.service import Service
...
class Context_PathcompserviceUuidMethodView(MethodView):
    ...
    def put(self, uuid):
        ...
        try:
            ...
            new_object = create_instance(Service, json_struct)
            if isinstance(new_object, BadRequestError):
                return new_object
            elif isinstance(new_object, NotFoundError):
                return new_object
    ...
    def post(self, uuid):
        ...
        try:
            ...
            json_struct = request.get_json() #json parser.
            new_object = create_instance(Service, json_struct, (uuid,'uuid'))
            if isinstance(new_object, BadRequestError):
                return new_object
            elif isinstance(new_object, NotFoundError):
                return new_object
