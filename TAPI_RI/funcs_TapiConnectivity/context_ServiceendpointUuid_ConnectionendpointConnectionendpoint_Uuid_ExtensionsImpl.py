...
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_ExtensionsImpl:
    ...
    def get(cls, uuid, connectionEndPoint_uuid):
        ...
        if uuid in be.Context._serviceEndPoint:
            if connectionEndPoint_uuid in be.Context._serviceEndPoint[uuid]._connectionEndPoint:
                return be.Context._serviceEndPoint[uuid]._connectionEndPoint[connectionEndPoint_uuid]._extensions
            else:
