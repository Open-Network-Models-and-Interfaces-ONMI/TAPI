...
class Context_ConnectionUuid_ConnectionportLocalid_Connectionendpoint_LayerprotocolLocalid_ExtensionsImpl:
        ...
        if uuid in be.Context._connection:
            if localId in be.Context._connection[uuid]._connectionPort:
                if localId in be.Context._connection[uuid]._connectionPort[localId]._connectionEndPoint._layerProtocol:
                    return be.Context._connection[uuid]._connectionPort[localId]._connectionEndPoint._layerProtocol[localId]._extensions
                else:
