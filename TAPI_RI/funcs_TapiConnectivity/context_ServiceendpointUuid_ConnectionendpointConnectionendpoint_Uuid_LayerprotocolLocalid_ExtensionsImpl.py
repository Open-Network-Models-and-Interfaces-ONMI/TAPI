...
class Context_ServiceendpointUuid_ConnectionendpointConnectionendpoint_Uuid_LayerprotocolLocalid_ExtensionsImpl:
        ...
        if uuid in be.Context._serviceEndPoint:
            if connectionEndPoint_uuid in be.Context._serviceEndPoint[uuid]._connectionEndPoint:
                if localId in be.Context._serviceEndPoint[uuid]._connectionEndPoint[connectionEndPoint_uuid]._layerProtocol:
                    return be.Context._serviceEndPoint[uuid]._connectionEndPoint[connectionEndPoint_uuid]._layerProtocol[localId]._extensions
                else:
