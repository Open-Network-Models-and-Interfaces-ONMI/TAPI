    ...
    def get(cls, uuid, link_uuid, riskCharacteristicName):
        ...
        if uuid in Context._topology:
            if link_uuid in Context._topology[uuid]._link:
                if riskCharacteristicName in Context._topology[uuid]._link[link_uuid]._riskParameter.riskCharacteristic:
                    return Context._topology[uuid]._link[link_uuid]._riskParameter.riskCharacteristic[riskCharacteristicName]
                else:
