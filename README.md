# Linux Foundation ONMI Project Transport API (TAPI)

**This is the release version ***2.1.5*** of the Linux Foundation ONMI Project Transport API (TAPI) SDK
...
- **_TAPI UML Information Model_** - The TAPI UML models included in this TAPI release (v2.1.5) are a partially normative part of the TAPI SDK and are the only source for subsequent generated TAPI SDK components (YANG, OAS, etc.).
...
- **_TAPI YANG Schema_** - The TAPI YANG models included in this TAPI release (v2.1.5) are a normative part of the TAPI SDK.
 ...
 YANG models included in this release are backward compatible with previous ***TAPI 2.1.3*** release.

- **_TAPI OpenAPI Specification_** - TAPI OAS (OpenAPI Specifications) included in this TAPI release (v2.1.5) are an informative part of the TAPI SDK.
  ...
  - The OAS has not been changed from the version released with TAPI release v2.1.3.
  
- [Documentation associated with this release](https://github.com/Open-Network-Models-and-Interfaces-ONMI/TAPI-Documentation/releases/tag/v2.1.5)
...
## What's Changed
* Tapi 2.1.3 fixes by @nigel-r-davis in https://github.com/Open-Network-Models-and-Interfaces-ONMI/TAPI/pull/661
* YANG updates for 2.1.5 by @nigel-r-davis in https://github.com/Open-Network-Models-and-Interfaces-ONMI/TAPI/pull/663
